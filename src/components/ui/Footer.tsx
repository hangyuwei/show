...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-6 pt-4">
        <div className="flex items-center justify-between rounded-2xl px-6 py-4 backdrop-blur-xl bg-white/5 border border-white/10">
          {/* Left: Copyright */}
